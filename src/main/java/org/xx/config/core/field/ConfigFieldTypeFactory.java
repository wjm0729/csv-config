...
public class ConfigFieldTypeFactory {
    ...
    static {
        List<Class<?>> classList = ClassUtil.getClassList(IFieldType.class.getPackage().getName()+".impl", true, IFieldType.class, ConfigFieldTypeFactory.class.getClassLoader());
