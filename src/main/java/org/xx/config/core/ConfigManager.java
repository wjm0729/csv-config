...
import org.xx.config.core.util.PropertyConfig;
import org.xx.config.core.verify.VerifyContext;
import org.xx.config.core.watch.FileListener;
import org.xx.config.core.watch.ResourceListener;
import org.xx.config.core.util.ClassUtil;
...
public class ConfigManager {
    ...
    private String implPack = "com.farm.config";
    ...
    private void initContainer() {
        int count = 0;
        List<Class<?>> classes = ClassUtil.getClassList(implPack, true, Config.class, getClass().getClassLoader());
    ...
    public void init(String implPack, String resPath) throws Exception {
    ...
    private Class<? extends ConfigContainer> getContainerClass(String fileName) throws ClassNotFoundException {
        ...
        String containerName = CommonUtils.camelName(fileName) + "Container";
        try {
